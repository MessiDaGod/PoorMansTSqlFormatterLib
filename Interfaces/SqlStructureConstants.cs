namespace PoorMansTSqlFormatterLib.Interfaces
{
	public static class SqlStructureConstants
	{
		...
		public static string[] ENAMELIST_COMMENT = new string[3] { "MultiLineComment", "SingleLineComment", "SingleLineCommentCStyle" };

		public static string[] ENAMELIST_NONCONTENT = new string[4] { "WhiteSpace", "MultiLineComment", "SingleLineComment", "SingleLineCommentCStyle" };

		public static string[] ENAMELIST_NONSEMANTICCONTENT = new string[4] { "Clause", "DDLProceduralBlock", "DDLOtherBlock", "DDLDeclareBlock" };
	}
}
